#ifndef _DOZLIXON_KEYMAP_H_
#define _DOZLIXON_KEYMAP_H_
...
struct Keyboard::KeyMap
{
	//½âÎöÉ¨ÃèÂëÎªÏàÓ¦µÄ¼üÅÌ×Ö·û
	static const __U32 MAPPED_KEY[NR_SCAN_CODES * MAP_COLS];
};

const __U32 Keyboard::KeyMap::MAPPED_KEY[NR_SCAN_CODES * MAP_COLS] = {
